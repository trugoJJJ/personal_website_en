...
const TechStackSectionContent = () => {
  ...
  const techStack = [
    ...
    { category: "Project Management", items: [{ name: "Notion", url: "https://notion.so" }, { name: "Asana", url: "https://asana.com" }, { name: "Trello", url: "https://trello.com" }, { name: "Dynamics 365", url: "https://dynamics.microsoft.com" }, { name: "Slack", url: "https://slack.com" }, { name: "HubSpot CRM", url: "https://hubspot.com" }, { name: "Pipedrive", url: "https://pipedrive.com" }, { name: "SALESmanago", url: "https://salesmanago.com" }] },
