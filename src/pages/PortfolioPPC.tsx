                  ...
                  <div className="p-8" style={cardBase('white')}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-2xl text-green-600">17%</div>
                        <div className="text-xs mt-1" style={{ opacity: .7 }}>Wzrost współczynnika konwersji</div>
                      </div>
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-2xl text-green-600">120</div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2">
                  <div className="p-8" style={cardBase('white')}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-2xl text-blue-600">180</div>
                        <div className="text-xs mt-1" style={{ opacity: .7 }}>Rejestracji na webinar</div>
                      </div>
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-2xl text-blue-600">28 zł</div>
                ...
                <div className="md:col-span-2">
                  <div className="p-8" style={cardBase('white')}>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-xl text-green-600">+40%</div>
                        <div className="text-xs mt-1" style={{ opacity: .7 }}>Wzrost zapytań</div>
                      </div>
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-xl text-green-600">-27%</div>
                        <div className="text-xs mt-1" style={{ opacity: .7 }}>Obniżenie CPC</div>
                      </div>
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-xl text-green-600">5x</div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2">
                  <div className="p-8" style={cardBase('white')}>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-xl text-purple-600">+8%</div>
                        <div className="text-xs mt-1" style={{ opacity: .7 }}>Wzrost sprzedaży</div>
                      </div>
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-xl text-purple-600">2,8%</div>
                        <div className="text-xs mt-1" style={{ opacity: .7 }}>Konwersja Google</div>
                      </div>
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-xl text-purple-600">1,9%</div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="md:col-span-2">
                  <div className="p-8" style={cardBase('white')}>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-xl text-red-600">750</div>
                        <div className="text-xs mt-1" style={{ opacity: .7 }}>Wypełnionych formularzy</div>
                      </div>
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-xl text-red-600">4%</div>
                        <div className="text-xs mt-1" style={{ opacity: .7 }}>Współczynnik konwersji</div>
                      </div>
                      <div className="text-center p-4" style={cardBase('ecru')}>
                        <div className="font-extrabold text-xl text-red-600">16 PLN</div>
