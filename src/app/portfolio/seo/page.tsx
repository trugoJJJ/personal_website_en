            ...
            <div className="container mx-auto max-w-6xl px-6">
              ...
              <div className="space-y-24">
                ...
                <div>
                  ...
                  {/* Galeria przeniesiona z sekcji tytułowej - tylko ujęcia 2 i 3 */}
            ...
            <div className="container mx-auto max-w-6xl px-6">
              ...
              <div className="space-y-8">
                {[{
                  ...
                  d: 'Strategia iteracyjna – dopasowywana do algorytmów Google i priorytetów biznesowych (sezonowość, nowe linie produktowe). Gdy Google zmienia algo, natychmiast dostosowuję taktykę.'
                },{
                  num: '03',
